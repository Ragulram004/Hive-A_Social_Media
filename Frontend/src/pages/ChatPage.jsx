...
import { MdPersonSearch, MdArrowBack } from "react-icons/md";
...
const ChatPage = () => {
  ...
  return (
    <Box position="absolute" left="50%" transform="translateX(-50%)" w={{ base: "100%", md: "80%", lg: "800px" }} p={4}>
      <Flex gap={4} flexDirection={{ base: "column", md: "row" }} maxW={{ sm: "100%", md: "full" }} mx="auto">
          ...
          <Flex flex={30} gap={2} flexDirection="column" maxW={{ sm: "250px", md: "full" }} mx="auto">
            ...
            <form onSubmit={handleConversationSearch}>
              <Flex alignItems="center" gap={2}>
                ...
                <Button size="sm" variant="surface" type="submit">
        ...
        {isMobileView && selectedConversation._id ? (
          <Flex flex={70} borderRadius="md" p={2} flexDir="column" alignItems="center" justifyContent="center" height="400px">
            <Button variant="surface" size="sm" onClick={() => setSelectedConversation({})} aria-label="Back" mb={2} ><MdArrowBack/></Button>
            <MessageContainer />
          </Flex>
        ) : (!isMobileView && selectedConversation._id) ? (
          <MessageContainer />
