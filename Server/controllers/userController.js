...
const getSuggestedUsers = async (req, res) =>{
  try{
    // exclude current user from suggested users, exclude the already following users
    const userId = req.user._id
...
export { signupUser, loginUser, logoutUser,followUnFollowUser,updateUser,getUserProfile, getSuggestedUsers, disableAccount }